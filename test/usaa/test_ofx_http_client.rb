...
class USAAOFXHTTPClientTest < Test::Unit::TestCase
    ...
    def test_account_info_request_to_usaa
...
<DTACCTUP>19700101
        ...
        client = OFX::HTTPClient.new(URI.parse('https://service2.usaa.com/ofx/OFXServlet'))
